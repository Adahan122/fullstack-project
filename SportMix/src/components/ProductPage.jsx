        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
              <Typography
                variant='subtitle1'
                sx={{ color: '#0f449e', fontWeight: 'bold', textTransform: 'uppercase', mb: 1 }}
              >
                {product.brand}
              </Typography>
              ...
              <Typography variant='body1' sx={{ color: '#555', mb: 4, lineHeight: 1.8 }}>
                {product.description ||
                  'Высококачественный спортивный товар, созданный специально для достижения максимальных результатов.'}
              </Typography>
                    ...
                    {product.sizes.map((size) => (
                      <Button
                        ...
                        sx={{
                          ...
                          '&:hover': {
                            borderColor: '#0f449e',
                            bgcolor: selectedSize === size ? '#0b3376' : '#f5f5f5',
                          },
                        }}
                      >
                        {size}
