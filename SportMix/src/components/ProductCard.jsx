...
function ProductCard({ item, onOpenDetail, isFavorite = false, onToggleFavorite }) {
  ...
  return (
    ...
    >
      ...
      <Box
        sx={{
          p: { xs: '10px 12px 12px', sm: '12px 14px 14px' },
          display: 'flex',
          flexDirection: 'column',
          flexGrow: 1,
          gap: 0.4,
      ...
      >
        <Box display='flex' alignItems='baseline' gap={0.5} sx={{ mb: '1px' }}>
          <Typography
            variant='body1'
            sx={{ fontWeight: 800, color: '#000', fontSize: { xs: '0.9rem', sm: '1rem' } }}
          >
        ...
        <Button
          ...
          sx={{
            backgroundColor: isOutOfStock ? '#cbd5e1' : '#1976d2',
            color: '#fff',
            borderRadius: '6px',
            textTransform: 'none',
            fontWeight: 700,
            ...
            py: 1,
            boxShadow: 'none',
            '&:hover': { backgroundColor: isOutOfStock ? '#cbd5e1' : '#1565c0', boxShadow: 'none' },
          }}
        >
