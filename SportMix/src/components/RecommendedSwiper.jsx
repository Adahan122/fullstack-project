...
function RecommendedSwiper({ products, title }) {
  ...
  return (
    <Box sx={{ width: '100%', mb: 1 }}>
      <Typography
        variant='h5'
        sx={{ fontWeight: 900, mb: 3, color: '#0f172a', letterSpacing: '-0.03em' }}
      >
        {title}
      </Typography>
              ...
              >
                ...
                >
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.8 }}>
                    <Chip
                      label={item.subcategory || item.category || 'Sport'}
                      sx={{
                  ...
                  >
                    {isFavorite(item.id) ? (
                      ...
                      <FavoriteBorderIcon sx={{ color: '#475569' }} />
                    )}
                  </IconButton>
                </Box>
                ...
                <Box sx={{ p: 2.2, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <Typography
                    sx={{ fontWeight: 800, mb: 1, color: '#0f172a', flexGrow: 1, lineHeight: 1.35 }}
                  >
                    {item.name}
                  </Typography>
                  ...
                  >
                    ...
                    <IconButton
                      ...
                      sx={{
                        ...
                        borderRadius: '14px',
                        boxShadow: isOutOfStock ? 'none' : '0 12px 24px rgba(15,68,158,0.22)',
                      }}
